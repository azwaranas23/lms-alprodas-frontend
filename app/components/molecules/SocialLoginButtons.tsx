    ...
    <>
      <div className="relative">
        <div className="absolute inset-0 flex items-center">
          <div className="w-full border-t" style={{ borderColor: '#DCDEDD' }}></div>
        </div>
        <div className="relative flex justify-center text-sm">
          <span className="px-2 bg-[#F9F9F9] text-brand-light text-sm font-normal">Or continue with</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <button className="border border-[#DCDEDD] rounded-[8px] hover:border-[#0C51D9] hover:border-2 hover:bg-gray-50 transition-all duration-300 flex p-3 justify-center items-center gap-3 bg-white">
          ...
          <span className="ml-2 text-gray-600 text-sm font-semibold">Google</span>
        </button>
        <button className="border border-[#DCDEDD] rounded-[8px] hover:border-[#0C51D9] hover:border-2 hover:bg-gray-50 transition-all duration-300 flex p-3 justify-center items-center gap-3 bg-white">
          <svg className="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 24 24">
            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
          </svg>
          <span className="ml-2 text-gray-600 text-sm font-semibold">Facebook</span>
        </button>
      </div>
