        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-3 bg-white border rounded-[16px] transition-all duration-300 ${validationErrors.email
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={handleInputChange}
              disabled={loginMutation.isPending}
              className={`w-full pl-10 pr-10 py-3 bg-white border rounded-[16px] transition-all duration-300 ${validationErrors.password
                  ? 'border-[#DC2626] border-2'
                  : 'border-[#DCDEDD] hover:border-[#0C51D9] hover:border-2 focus:border-[#0C51D9] focus:border-2 focus:bg-white'
                }`}
