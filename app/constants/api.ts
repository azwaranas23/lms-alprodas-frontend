...
export const courseKeys = {
  ...
  byMentor: (mentorId: number) =>
    [...courseKeys.all, "mentor", mentorId] as const,
} as const;
...
export const lessonKeys = {
  ...
  byCourse: (courseId: number) =>
    [...lessonKeys.all, "course", courseId] as const,
  bySection: (sectionId: number) =>
    [...lessonKeys.all, "section", sectionId] as const,
} as const;
...
export const withdrawalKeys = {
  ...
  byMentor: (mentorId: number) =>
    [...withdrawalKeys.all, "mentor", mentorId] as const,
...
export const transactionKeys = {
  ...
  mentor: {
    ...
    list: (filters?: Record<string, any>) =>
      [...transactionKeys.mentor.lists(), { filters }] as const,
  },
  student: {
    all: ["transactions", "student"] as const,
    lists: () => [...transactionKeys.student.all, "list"] as const,
    list: (filters?: Record<string, any>) =>
      [...transactionKeys.student.lists(), { filters }] as const,
  },
