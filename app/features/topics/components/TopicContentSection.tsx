	...
	useEffect(() => {
		const fetchSubjects = async () => {
			try {
				...
				const response =
					await subjectsService.getSubjectsByTopic(topicId);
	...
	useEffect(() => {
		const fetchCourses = async () => {
			try {
				...
				const response = await coursesService.getCoursesByTopic(
					topicId,
					{ page: 1, limit: 6 }
				);
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<Card className="mb-6 p-6">
					<div className="flex flex-wrap gap-2">
						<Button
							variant={
								activeTab === "subjects" ? "primary" : "outline"
							}
						...
						<Button
							variant={
								activeTab === "courses" ? "primary" : "outline"
							}
						...
						<div>
							<div className="mb-6">
								...
								<p className="text-brand-light text-lg">
									Explore specialized subjects within this
									topic
								</p>
							</div>
